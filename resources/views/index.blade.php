...
<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner" style="padding-left:10px;width:200%">
                        ...
                        <div class="col col-12 col-sm-5 col-lg-5 col-md-5 col-xl-12 col-xxl-12" >
                            <div class="item active" id="video">
                                <video id="video" muted autoplay="autoplay" loop="loop" preload="auto">
                                  <source src="https://media.istockphoto.com/videos/walking-upstairs-closeup-view-of-mans-leather-shoes-business-stairs-video-id1173605592"></source>
                                </video>
                              </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col col-12 col-sm-5 col-lg-5 col-md-5 col-xl-12 col-xxl-12" >
                            <div class="item active" id="video">
                                <video id="video" muted autoplay="autoplay" loop="loop" preload="auto">
                                  <source src="https://media.istockphoto.com/videos/reading-electronic-books-blue-version-video-id185423461"></source>
                                </video>
                              </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col col-12 col-sm-5 col-lg-5 col-md-5 col-xl-12 col-xxl-12" >
                            <div class="item active" id="video">
                                <video id="video" muted autoplay="autoplay" loop="loop" preload="auto">
                                  <source src="https://media.istockphoto.com/videos/elearning-education-related-video-id957653658"></source>
                                </video>
                              </div>
                    </div>
                </div>
    ...
    <span class="visually-hidden">Next</span>
       ...
       <form action="" method="post">
        ...
        <ul class="list-unstyled" style="font-size: 20px;color: rgb(247, 252, 247);">
          ...
          <!-- <td> <ul class="list-unstyled" style="font-size: 20px;color: rgb(247, 252, 247);">Remember me<br></ul> </td>
          <td> -->
               <!-- <input class="form-check-input" type="radio" name="reme" id="flexRadioDefault1">
             ...
             <tr>
              <td> <input class="btn btn-primary" type="submit" name="btnlog" value="Login"></td>
              <td>  <button class="btn btn-primary" type="reset" name="btnlog1">Cancel</button></td>
          </tr>
          
          <tr>
              <td></td>
              <td><a href="/Login" class="btn btn-primary"> <ul class="list-unstyled" style="font-size: 20px;color: rgb(247, 252, 247);">New User</ul></a></td>
          </tr>
